...
@Component({
  ...
  `,
  styles: [`
    :host { display: inline-flex; min-height: var(--control-h); }
    .pills { display: inline-flex; min-height: var(--control-h); border: 0; box-shadow: inset 0 0 0 1px var(--line-strong); }
